...
| Tahap | Deskripsi | Dokumentasi Lengkap |
| :--- | :--- | :--- |
| **Tahap 1** | Scraping komentar YouTube menggunakan YouTube Data API v3 | 📄 [Lihat Detail →](docs/scraping.md) |
| **Tahap 2** | Preprocessing, pelabelan otomatis, ekstraksi fitur, dan pelatihan model | 📄 [Lihat Detail →](docs/training.md) |
| **Evaluasi** | Hasil eksperimen dan perbandingan 3 skema model | 📄 [Lihat Detail →](docs/evaluation.md) |
